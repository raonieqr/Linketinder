  ...
  var e = {
    531 : function(e, t, n) {
      var a = this && this.__createBinding || (Object.create ? function(e, t, n, a) {
                ...
                i && !("get" in i ? !t.__esModule
                                  : i.writable || i.configurable) ||
                    (i = {enumerable : !0, get : function() { return t[n] }}),
        ...
        if (null != e)
          for (var n in e)
            "default" !== n && Object.prototype.hasOwnProperty.call(e, n) &&
                a(t, e, n);
        return i(t, e), t
      };
      Object.defineProperty(t, "__esModule", {value : !0});
      const r = l(n(654)), o = document.getElementById("modal"),
      ...
      p && p.addEventListener("click", (function() {
                                ...
                                if (!e || !t || !n)
                                  return void alert("Error: campo vazio");
      ...
      function m() {
        ...
        if (!e || !t)
          return void (n && (n.innerHTML = "<h2>Sem vaga</h2>"));
        const a = JSON.parse(e), i = JSON.parse(t);
        if (!a.vacancy || !a.vacancy.skills || !i.skills)
          return;
      ...
      v && v.addEventListener(
               "click", (function() {
                 (function() {
                   if (function() {
                         const e = r.getInput("name"), t = r.getInput("email"),
                               n = r.getInput("skills"), a = r.getInput("age"),
                               i = r.getInput("cpf"), l = r.getInput("cep"),
                               o = r.getInput("password"),
                               c = r.getInput("description");
                         if (r.isEmpty(e) || r.isEmpty(t) || r.isEmpty(n) ||
                             r.isEmpty(a) || r.isEmpty(i) || r.isEmpty(l) ||
                             r.isEmpty(o) || r.isEmpty(c))
                           return alert("Error: Nenhum campo pode estar vazio"),
                                  !1;
                         const u =
                             r.validateInput(e, "nome") && r.validateCpf(i) &&
                             r.validateAge(a) && r.validateCep(l) &&
                             r.validateDescription(c) && r.validateEmail(t);
                     ...
                     const d = {
                       ...
                       email : t.value,
                       skills : Array.from(u).join().toLowerCase().trim().split(
                           /[;, ]+/),
                       description : c.value,
                       cpf : i.value,
                     ...
                     return localStorage.setItem("candidateLocal",
                                                 JSON.stringify(d)),
                            !0
                   }
                   return !1
          ...
          document.addEventListener(
              "DOMContentLoaded", (function() {
                ...
                e && e.addEventListener("click", (function() { m() }))
              })),
          function() {
            ...
            if (r)
              var o = JSON.parse(r);
            o.vacancy &&
                (a.innerText = o.vacancy.name, i.innerText = "x",
                 l.innerText = o.vacancy.skills, null == t || t.appendChild(a),
                 null == t || t.appendChild(i), null == t || t.appendChild(l),
                 t && e &&
                     (null == e || e.appendChild(t),
                      null == n || n.appendChild(e)))
          }()
    },
    654 : (e, t) => {
      function n(e) { return /^\d+$/.test(e) }
      function a(e) {
        return /[/[0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/.test(e)
      }
      function i(e) { return /\S+@\w+\.\w{2,6}(\.\w{2})?/g.test(e) }
      function l(e) { return alert(e), !1 }
      Object.defineProperty(t, "__esModule", {value : !0}),
          t.getInput = t.isLoginValid = t.parseSkillsInput = t.validateCnpj =
              t.validatePasswordLength = t.isEmpty = t.validateDescription =
                  t.validateEmail = t.validateCep = t.validateAge =
                      t.validateCpf = t.validateInput = t.showAlert =
                          t.validationEmail = t.isSpecialCharacter = t.isDigit =
                              void 0,
          t.isDigit = n, t.isSpecialCharacter = a, t.validationEmail = i,
          t.showAlert = l, t.validateInput = function(e, t) {
            return a(e.value) || n(e.value) ? l(`Error: ${t} inválido`)
                                            : e.value
            ...
            return n(e.value) && 8 === e.value.length ? e.value
                                                      : l("Error: cep inválido")
          }, t.validateEmail = function(e) {
            return n(e.value) || !i(e.value) ? l("Error: email inválido")
                                             : e.value
          ...
          }, t.getInput = function(e) { return document.getElementById(e) }
    }
  },
      t = {};
  !function n(a) {
